        ...
        <div className='flex items-end justify-center absolute w-full z-50'>
            <div className="flex flex-col items-center justify-between h-160">
                <div className="relative inline-block overflow-hidden">
                    <Image className='animate-EaseIn relative block' style={{ width: 'auto', height: 'auto' }}
                        priority src="/jo-hair-logo.png" alt="logo" width={270} height={216} />
                    <div className="silk-mask absolute inset-0 z-100 pointer-events-none blur-[10px]"></div>
                </div>
